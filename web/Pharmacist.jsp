            ...
            <aside>
                <div id="sidebar"  class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            <a class="active" href="./PopulateTableServlate?action=populatePharmacist" >
            ...
            *********************************************************************************************************************************************************** -->
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="alert alert-success" >
                                <div class="text-center text-capitalize">
                                    <b>Hallo ${ admin.getUsername()}</b> Select Pharmacist in table to edit
                                </div>
                            </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <c:forEach items="${ps}" var="p">
                                                            ...
                                                            <tr onclick="javascript:showRow(this);">
                                                                <td><c:out value="${p.docID}" /></td>
                                                                <td><c:out value="${p.fName}" /></td>
                                                                <td ><c:out value="${p.sName}" /></td>
                                                                <td class="numeric"><c:out value="${p.dob}" /></td>
                                                                <td class="numeric"><c:out value="${p.pass}" /></td>
                                                                <td class="numeric"><c:out value="${p.dateCreated}" /></td>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 mb">
                                    ...
                                    <div class="darkblue-panel pn" style="margin-top: 55px; height: 550px;">
                                        <div class="darkblue-header">
                                            <h5>Selected Pharmacist Information</h5>
                                        </div>
                                        <h1 class="mt"><i class="fa fa-user fa-3x"></i></h1>
                                        
                                        <form id="phTable" class="form-horizontal tasi-form"  method="post">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button id="savePharmacist" type="button" class="btn btn-success">Save Changes</button>
                                                <button id="deletePharmacist" type="button" class="btn btn-danger">Delete Pharmacist</button>
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            $(document).ready(function () {
                                                ...
                                                $('#deletePharmacist').click(function (event) {
                                                    event.preventDefault();

                                                    $.ajax({
                                                        type: 'POST',
                                                        data: $("#phTable").serialize(),
                                                        url: "UDoperations?action=deletePharmacist",
                                            ...
                                            $(document).ready(function () {
                                                ...
                                                $('#savePharmacist').click(function (event) {
                                                    event.preventDefault();

                                                    $.ajax({
                                                        type: 'POST',
                                                        data: $("#phTable").serialize(),
                                                        url: "UDoperations?action=savePharmacist",
                                                        success: function (result) {
                                                            $('#err_p').html(result);
                                                        }
                                                    });
            ...
            <footer class="site-footer">
                <div class="text-center">
                    2016
                    <a href="Pharmacist.jsp#" class="go-top">
