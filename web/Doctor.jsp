                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 mb">
                                    ...
                                    <div class="darkblue-panel pn" style="margin-top: 55px; height: 550px;">
                                        <div class="darkblue-header">
                                            <h5>Selected Doctor Information</h5>
                                        </div>
                                        <h1 class="mt"><i class="fa fa-user fa-3x"></i></h1>
                                        <div class="panel-body">

                                            <form id="docT" class="form-horizontal tasi-form" method="post">

                                                <div class="form-group ">
                                                    <label class="col-sm-2 control-label col-lg-3 text-primary" for="inputSuccess">Doctor ID</label>
                                                    <div class="col-lg-9">
                                                        <input name="did" type="text" class="form-control" id="pID">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="modal-footer">
                                                    <button id="saveDoctor" type="submit" class="btn btn-success">Save Changes</button>>
                                                    <button id="deleteDoc" type="submit" class="btn btn-danger">Delete Doctor</button>
                                                    <a href="./UDoperations?action=printDoctor" class="btn btn-info">Print Doctor</a>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            $(document).ready(function () {
                                                ...
                                                $('#deleteDoc').click(function (event) {
                                                    ...
                                                    $.ajax({
                                                        type: 'POST',
                                                        data: $("#docT").serialize(),
                                                        url: "UDoperations?action=deleteDoctor",
                                            ...
                                            $(document).ready(function () {
                                                ...
                                                $('#saveDoctor').click(function (event) {
                                                    event.preventDefault();

                                                    $.ajax({
                                                        type: 'POST',
                                                        data: $("#docT").serialize(),
                                                        url: "UDoperations?action=saveDoctor",
                                                        success: function (result) {
                                                            $('#err_p').html(result);
